...
public class Profile_Absensi extends Fragment {
    private static final String TAG = Profile_Absensi.class.getSimpleName(); //getting the info
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_profile__absensi, container, false);
        ...
        readProfile();
        back1.setOnClickListener(view -> kembali(new Absensi()));
        back2.setOnClickListener(view -> kembali(new Absensi()));
        return  v;
    }
